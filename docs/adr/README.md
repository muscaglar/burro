...
| [0030](0030-a-release-is-kept-approved-by-its-lock-and-carried-in-the-image.md) | A release is kept in a bucket of its own, approved by its lock, and carried in the image | Accepted. Nothing of it has run on a host |
