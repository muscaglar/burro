...
| `catalogue.json` | `{"catalogue_version": 14, "metrics": [...], "vibes": [...]}` | a feature this release carries, and a vibe it carries | 2.3 |
...
```json
{"meta": {"release_id": "syn-2026-09-23-01", "engine_version": "1.14.0", "synthetic": true,
          "preview": false},
 "data": {}}
```
