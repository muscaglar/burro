...
| `ons-price-index-of-private-rents` | ONS dataset page | XLSX, 17.8 MB W | OGL v3. Attribution wording: a question for the statistics office, or the workbook's cover sheet | Borough code, bedrooms | Was to be the borough anchor of a rent model, which was never designed. Not read for the rent of a release since 2026-09-25: it gives one modelled average for a borough and nothing smaller | None | Monthly. Next 21 October 2026 W. Last two months provisional R | Layout never opened R. All tenancies, so it understates a new let R. No room or studio figure ? | 32 boroughs. City of London not published R |
| `ons-private-rental-market-london-postcode-district` | ONS ad hoc 3389, `londonrentalstatsaccessibleq12026.xlsx` R | XLSX, 129.4 kB R | OGL v3. Save the workbook's caveat. A question for the statistics office: does the series continue | Postcode district and bedrooms, and borough and bedrooms. District to OA through ONSPD, by homes | Since 2026-09-25 shown as the publisher gives it: the median and both quartiles of the postcode district where half or more of an area's homes stand, or of its borough, with the place, the months and the count said beside it, and a budget to rent held against the median ([ADR 0021](../adr/0021-a-price-is-shown-as-the-publisher-gives-it.md), as amended). It was to be a ratio inside a model, never shown raw | `cost.json`, rent | Frozen: no edition since April 2026 R. Archive all nine | ONS says the figures should not be compared between areas R. Burro holds a budget against them in one area after another, and says what the publisher advises wherever a person reads the figures. Under 5 observations is suppressed R | 247 of 329 districts have a median. Gaps in W1 and the City R |
...
| 5. Cost | Price Paid (three or four yearly files), UK HPI, rents index, rent workbook, ONSPD, TS050 | A buy range by property type and a rent range by bedrooms for each area. Since 2026-09-25 the rent is that of the postcode district or the borough an area lies in, as its publisher gives it, and no model stands behind it | Under 30 minutes | The question for HM Land Registry before launch |
...
One area fails the test as written. The rents index does not publish the City of London R, so an area there has no rent anchor. Section 10 puts the choice to the founder. Since 2026-09-25 the rents index is not read: the rent workbook gives the City of London a row of its own, as a borough.
