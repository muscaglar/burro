"""Takeaways: how many are within reach of where homes are.

The register has one kind for a takeaway and a sandwich shop, and the
...
for a feature of takeaways alone.
"""
...
WHAT = counted(KEY, "Takeaways and sandwich shops", Group.TAKEAWAY)
...
CANNOT_SEE = (
    *venue_food_drink.OF_EVERY_KIND,
    "The register has one kind for a takeaway and a sandwich shop, so it cannot tell one from "
    "the other, and it cannot say what a place sells, what it charges or when it is open.",
