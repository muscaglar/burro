...
- What moved is held by `tests/test_panel_moved.py`, which asks the panel with no port, on the made-up city held against itself with one figure lower and one measure gone.
